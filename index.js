...
//Setting up server port and logging message on success.
app.listen(process.env.PORT || 1337, () => console.log('webhook is listening'));


//Creating end-point for our web-webhook
...
//Adds support for GET requests to our webhook_event
app.get('/webhook', (req, res) => {

  //The verify token. Should be a random string
  let VERIFY_TOKEN = "monkeydance";
  ...
  if (mode && token) {
    ...
    if (mode === 'subscribe' && token ===VERIFY_TOKEN) {
      //Responds to the challenge token fro the request
